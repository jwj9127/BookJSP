...
<body>
   <%
      ...
      String DetailLoad = "SELECT bookCtg, price, bookStock, writer, bookName, bookContent, publisher, bookImg, bookStatus, bookReview FROM Book WHERE bookName LIKE ?";

      PreparedStatement pstmtDL = con.prepareStatement(DetailLoad);
      String keyword = "%" + bookName + "%";
      pstmtDL.setString(1, keyword);
      ResultSet rsDL = pstmtDL.executeQuery();


      if (rsDL.next()) { // 결과 집합이 비어있지 않은 경우에만 처리
         ...
         String bookTitle = rsDL.getString("bookName");
...
<img src="images/menuButton06.png" alt="북클럽">
   ...
   <main>
      <section class="DetailOne">
         <img src="<%=bookImg%>.jpg" title="<%=bookTitle%>(<%=writer%>)" alt="<%=bookTitle%>">
         <div class="infoDO">
            <h1><%=bookTitle%></h1>
            <p>
