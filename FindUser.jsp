...
<body>
   ...
   <main class="LoginOne">
      <ul class="btnLogin">
         <li class="On"><a href="javascript:void(0);">아이디 찾기</a></li>
         ...
         <div class="contLO On">
            <form method="post" action="FindIdOk.jsp">
               <div class="mainLO">
                  <input type="text" style="border-radius: 5px 5px 0 0;" name="name" title="이름 입력" placeholder="이름을 입력하세요">
                  <input type="text" style="border-radius: 0 0 5px 5px;" name="phone" title="전화번호 입력" placeholder="전화번호를 입력하세요">
                  <button type="submit" title="아이디 찾기" alt="아이디 찾기 버튼">아이디 찾기</button>
               </div>
            </form>
         </div>
         <!-- 비밀번호 찾기 -->
         <div class="contLO">
            <form method="post" action="FindPwOk.jsp">
               <div class="mainLO">
                  <input type="text" style="border-radius: 5px 5px 0 0;" name="userid" title="아이디 입력" placeholder="아이디를 입력하세요">
                  <input type="text" style="border-radius: 0 0 5px 5px;" name="name" title="이름 입력" placeholder="이름을 입력하세요">
                  <input type="text" style="border-radius: 0 0 5px 5px;" name="phone" title="전화번호 입력" placeholder="전화번호를 입력하세요">
                  <input type="password" style="border-radius: 0 0 5px 5px;" name="password" title="새 비밀번호 입력" placeholder="새 비밀번호를 입력하세요">
                  <button type="submit" title="비밀번호 재설정" alt="비밀번호 재설정 버튼">비밀번호 재설정</button>
               </div>
            </form>
         </div>
   </main>
